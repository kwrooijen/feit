...
(defn- get-key [event]
  (get essen.keyboard/keys (.-keyCode event)))
...
(defn add-event-listeners! []
  (add-event-listener "keydown" (comp essen.keyboard/emit-keydown! get-key))
  (add-event-listener "keyup"   (comp essen.keyboard/emit-keyup!   get-key)))
