(ns rooij.module.matterjs.component
  (:require
   [rooij.system.component :as component]
   [rooij.module.matterjs.extra.position :as extra.position]
   ["matter-js" :as Matter :refer [Bodies]]
   [rooij.module.matterjs.shape.handler :as shape.handler]
   [rooij.module.matterjs.world :as matterjs.world]
