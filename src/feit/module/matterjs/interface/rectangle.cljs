(ns feit.module.matterjs.interface.rectangle
  (:require
   [clojure.core.matrix :as m]
   ["matter-js" :as Matter :refer [Bodies World Body]]
   [feit.interface.general-2d.position :refer [FeitGeneral2DPosition]]
   [feit.interface.physics-2d.rectangle :refer [FeitPhysics2DRectangle]]
   [feit.interface.physics-2d.shape :refer [FeitPhysics2DShape]]
...
(extend-protocol FeitPhysics2DShape
  MatterPhysics2DRectangle
  (get-velocity [this]
    (-get-velocity this))
