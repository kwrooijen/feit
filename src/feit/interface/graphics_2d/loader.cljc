...
(-> (r/component :graphics-2d.component/loader)
    (r/handler+ref :graphics-2d.handler.loader/load-complete)
    (r/handler+ref :graphics-2d.handler.loader/load-texture)
    (r/handler+ref :graphics-2d.handler.loader/load-spritesheet)
    (r/save-interface!))
