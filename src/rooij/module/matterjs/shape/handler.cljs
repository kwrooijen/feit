(ns rooij.module.matterjs.shape.handler
  (:require
...
(def config
  {[:rooij/handler :matterjs.handler.shape/apply-force] default-opts
   [:rooij/handler :matterjs.handler.shape/rotate] default-opts
   [:rooij/handler :matterjs.handler.shape/scale] default-opts
   [:rooij/handler :matterjs.handler.shape/set] default-opts
   [:rooij/handler :matterjs.handler.shape/set-angle] default-opts
   [:rooij/handler :matterjs.handler.shape/set-angularvelocity] default-opts
   [:rooij/handler :matterjs.handler.shape/set-density] default-opts
   [:rooij/handler :matterjs.handler.shape/set-inertia] default-opts
   [:rooij/handler :matterjs.handler.shape/set-mass] default-opts
   [:rooij/handler :matterjs.handler.shape/set-parts] default-opts
   [:rooij/handler :matterjs.handler.shape/set-position] default-opts
   [:rooij/handler :matterjs.handler.shape/set-static] default-opts
   [:rooij/handler :matterjs.handler.shape/set-velocity] default-opts
   [:rooij/handler :matterjs.handler.shape/set-vertices] default-opts
   [:rooij/handler :matterjs.handler.shape/translate] default-opts
   [:rooij/handler :matterjs.handler.shape/update] default-opts})
