...
(defn- get-key [event]
  (get rooij.keyboard/keys (.-keyCode event)))
...
(defn- add-event-listener
  ...
  ```clojure
  (rooij.keyboard/add-event-listener \"keydown\" es/emit-keydown!)
  (rooij.keyboard/add-event-listener \"keyup\" es/emit-keyup!)
  ```
...
(defn add-event-listeners! []
  (add-event-listener "keydown" (comp rooij.keyboard/emit-keydown! get-key))
  (add-event-listener "keyup"   (comp rooij.keyboard/emit-keyup!   get-key)))
